...
export default {
  'sensor.star': {
    ...
    body: `<p>Toutes les vingt secondes par défaut, et seulement au-dessus de 45 km, le viseur regarde le ciel, reconnaît ce qu'il voit et remet au filtre une attitude — entachée de quelques secondes d'arc de bruit, retiré à chaque visée. Le filtre l'exploite par une mise à jour à trois lignes, qui touche les trois états d'attitude et rien d'autre.</p>
